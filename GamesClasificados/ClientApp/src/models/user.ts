export class User {
  ...
  public static getUserFromObject(object: any): User {
    ...
    let user: User = new User(object.id, object.name, object.email, object.profilePictureURL, object.telephone, object.city, object.country, object.showPhone, object.showEmail, object.preferedContactMethod, object.username);
    return user;
  }
